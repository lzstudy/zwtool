...
#define CI_RET_P(ret, func)         CF_RET(!ret, -1, func);
#define CK_RET_U(ret)               CK_RET(ret < 0, ret);  
#define CI_RET_U(ret, func)         CF_RET(ret < 0, ret, func);
...
#define _CI_RET_P(ret, func)        _CF_RET(!ret, func);
#define _CK_RET_U(ret)              _CK_RET(ret < 0);  
#define _CI_RET_U(ret, func)        _CF_RET(ret < 0, func);
